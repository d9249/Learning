...
Format: Year, Conference, Paper, Link(Korean translation(Notion), Paper Link(Link), Summary(Notion), Open Review(Link), Official code(Link), Pytorch(Link), Reference(Link))

## 📕 Paper List up.

|Year|Conference|Paper|Link|
|-|--|---|---|
|2012|NIPS, Spotlight|imageNet Classification with Deep Convolutional Neural Network|[Korean translation](https://www.notion.so/imageNet-Classification-with-Deep-Convolutional-Neural-Network-74b0fc38e9af4073b421d284b1f25f60), [Paper Link](https://papers.nips.cc/paper/2012/file/c399862d3b9d6b76c8436e924a68c45b-Paper.pdf), [Summary](https://www.notion.so/Complete-78f08c463f714ce8a41f1f3e252d6c92), [Open review](https://openreview.net/forum?id=BJWjTIWOWr), [Official code](https://paperswithcode.com/paper/imagenet-classification-with-deep)|
