...
class SqEx(nn.Module):
    ...
    def __init__(self, n_features, reduction=16):
        ...
        #self.conv = nn.Conv2d(n_features,1,1)
...
class CPD_ResNet(nn.Module):
    ...
    def __init__(self, channel=32, inchannel=4):
        super(CPD_ResNet, self).__init__()
        self.resnet = B2_ResNet(inputchannel = inchannel)  # input_channel : 2 - GRAY, 4 - RGB
