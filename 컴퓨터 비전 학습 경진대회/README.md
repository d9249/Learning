...
| val_accuracy |              모델 | 상위-1 정확성 | 상위-5 정확성 |    매개변수 | 깊이 | Result Link |
|:-----:|------------------:|--------------:|--------------:|------------:|:----:|:---------:|
